...
export default function InternCard({ intern }: { intern: Megateam }) {
    return (
        <div id={`${intern.id}`} className="flex flex-col gap-3 sm:gap-5 p-9 md:p-9 border border-gray-300 shadow-md/30 shadow-gray-600 rounded-2xl">
            ...
            <div className="relative">
                ...
                <Link href={`/interns/${intern.id}`} className="">
                    <Image
                        ...
                        alt=""
                        className="rounded-2xl hover:scale-105 duration-200 brightness-100 md:brightness-90 md:hover:brightness-105 transition w-full h-auto"
                        width={300}
                        height={300}
                    />
                </Link>
