...
const EventsPage = () => {
    return (
        <div className='flex flex-col items-center mt-10 gap-7 pb-5 md:mt-15 md:gap-10 md:pb-10'>
            <h1 className='container text-center font-primary tracking-wider text-2xl sm:text-3xl md:text-4xl'>Upcoming Events!</h1>
            ...
            className="styled-calendar-container sm:h-172"
